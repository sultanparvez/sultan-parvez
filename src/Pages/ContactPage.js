            ...
            <InnerLayout className={'contact-section'}>
                <div className="left-content">
                    <div className="map-sect" >
                        ...
                        <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1qxhIOfwIRYD7NQnbZfZzwiiF-n2ybzNp&ehbc=2E312F" width="700" height="600"style={{border:1}} allowFullScreen="" aria-hidden="false" tabIndex="0"></iframe>
                    </div>
